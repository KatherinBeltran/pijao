...
@section('content_header')
    ...
    <div class="float-right">
        <a href="{{ route('zonas.create') }}" class="btn btn-block btn-outline-success btn-sm float-right" data-placement="left">
            {{ __('Nuevo') }}
        </a>
    </div>
    <div class="row">
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('zonas.destroy',$zona->id) }}" method="POST">
                            <a class="btn btn-sm btn-info" href="{{ route('zonas.show',$zona->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('') }}</a>
                            <a class="btn btn-sm btn-warning" href="{{ route('zonas.edit',$zona->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('') }}</a>
                            @csrf
                            @method('DELETE')
